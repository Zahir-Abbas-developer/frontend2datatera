                      ...
                      >
                                      ...
                                      >
                                        <Suspense fallback={<div>Loading History...</div>}>
                                          <TransformationHistory
                                            ...
                                            isTransformationHistoryLoading={isTransformationHistoryLoading}
                                          />
                                        </Suspense>
                                      </div>
                                    </div>
                        ...
                        {activeTab === "export" && (
                          <div className="export-tab">
                            <h4>{t("exportIntegration.chooseIntegrationTitle")}</h4>
                            <div className="Home_content_main">
                              <div className="home_content">
                                <div className="buttons-container">
                                  <button
                                    ...
                                    className={`custom-button ${
                                      isMappingSaving || isMappingDeleting || isConnectionsLoading || isFieldsLoading
                                        ? "disabled"
                                        : ""
                                    }`}
                                    disabled={
                                  ...
                                  >
                                    {isMappingSaving ? t("mapping.saveButton.saving") : t("mapping.saveButton.default")}
                                  </button>
                                  {(isMappingSaving || isMappingDeleting) && <div></div>}
                                  <button
                                    id="deleteButton"
                                    className={`custom-button ${
                                      isMappingSaving ||
                                  ...
                                  >
                                    {isMappingDeleting
                                      ? t("mapping.deleteButton.deleting")
                                      : t("mapping.deleteButton.default")}
                                  </button>
                                </div>

                                <div className="data_template_main">
                                  <h5>{t("exportIntegration.chooseIntegrationSubtitle")}</h5>
                                  <Select
                                    className="basic-single"
                                    classNamePrefix={t("exportIntegration.select.classNamePrefix")}
                                    options={connections}
                                ...
                                {selectedConnection && (
                                  <div className="data_template_main">
                                    <Suspense fallback={<div> {t("exportIntegration.loading")} </div>}>
                                      <IntegrationSelect
                                        selectedConnection={selectedConnection}
                                        handleFieldsFetched={handleFieldsFetched}
                                        setResource1FromSelect={setResource1FromSelect}
                                        setResource2FromSelect={setResource2FromSelect}
                                        setResource3FromSelect={setResource3FromSelect}
                                        setResource4FromSelect={setResource4FromSelect}
                                ...
                                <div className="data_template_main">
                                  <Table>
                                    <thead className="table_heading">
                                      <tr>
                                        <th>{t("exportIntegration.csvColumn")}</th>
                                        <th>{t("exportIntegration.firstRowValue")}</th>
                                        <th>
                                          {selectedConnection && selectedConnection?.label.toUpperCase()}{" "}
                                          {t("exportIntegration.connectionColumn")}{" "}
                                        </th>
                                      </tr>
                                    </thead>
                                    <tbody className="table_body">
                                      {tableHeaders?.map((header, index) => (
                                        <tr key={header}>
                                          <td>{header}</td>
                                          <td style={{ width: "45vw" }}>
                                            {tableData && tableData[0] ? tableData[0][index] : ""}
                                          </td>
                                          <td style={{ width: "15vw" }}>
                                            <Select
                                              className="basic-single"
                                              ...
                                              options={fields?.map((option) => ({
                                                ...option,
                                                isDisabled: isOptionDisabled(option, header),
                                              }))}
                                              isLoading={isFieldsLoading}
                                              isClearable={true}
                                              isDisabled={
                                                isFieldsLoading ||
                                                (integrationMapping && integrationMapping?.mapping[header])
                                              }
                                              onChange={(option) => handleSelectMappingChange(option, header)}
                                              value={
                                                (integrationMapping && integrationMapping?.mapping[header]) ||
                                          ...
                                          <td>
                                            <FontAwesomeIcon
                                              ...
                                              title={
                                                isFieldsLoading ||
                                                (integrationMapping && integrationMapping?.mapping[header])
                                                  ? t("exportIntegration.delete.enabled")
                                                  : t("exportIntegration.delete.disabled")
                                              }
                                            />
                                          </td>
                                        </tr>
